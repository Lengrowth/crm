...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "719af31b51515726a728e4870c95f34525c5ba99"' in workflow
    assert bundle_commit == "719af31b51515726a728e4870c95f34525c5ba99"
    ...
    assert '"commit": "719af31b51515726a728e4870c95f34525c5ba99"' in baseline
