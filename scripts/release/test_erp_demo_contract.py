...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "ea9f313327e402c4712a501dd853ef3c2a766b9b"' in workflow
    assert bundle_commit == "ea9f313327e402c4712a501dd853ef3c2a766b9b"
    ...
    assert '"commit": "ea9f313327e402c4712a501dd853ef3c2a766b9b"' in baseline
