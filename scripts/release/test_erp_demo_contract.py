...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "e87d3482e12f8864357c8cc1f49bf8f2247dbe70"' in workflow
    assert bundle_commit == "e87d3482e12f8864357c8cc1f49bf8f2247dbe70"
    ...
    assert '"commit": "e87d3482e12f8864357c8cc1f49bf8f2247dbe70"' in baseline
