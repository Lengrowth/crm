...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "ed41ec60b281d03cb8c82e6e123929672c991361"' in workflow
    assert bundle_commit == "ed41ec60b281d03cb8c82e6e123929672c991361"
    ...
    assert '"commit": "ed41ec60b281d03cb8c82e6e123929672c991361"' in baseline
