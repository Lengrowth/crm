...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert bundle_commit == "81a767fecf4ae35c181f29e024a967be3e80cc49"
    ...
    assert '"commit": "81a767fecf4ae35c181f29e024a967be3e80cc49"' in baseline
    ...
    archive = ROOT / "ops" / "staging" / "lenerp_core-81a767fecf4ae35c181f29e024a967be3e80cc49.tar"
