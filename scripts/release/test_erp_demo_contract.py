...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "7995bed04a7079953e447e6bf430e90bf0558f80"' in workflow
    assert bundle_commit == "7995bed04a7079953e447e6bf430e90bf0558f80"
    ...
    assert '"commit": "7995bed04a7079953e447e6bf430e90bf0558f80"' in baseline
