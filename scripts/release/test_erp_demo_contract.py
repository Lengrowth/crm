...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert bundle_commit == "44376c8214ad4c0974801d39cc1081a563233fd3"
    ...
    assert '"commit": "44376c8214ad4c0974801d39cc1081a563233fd3"' in baseline
    ...
    archive = ROOT / "ops" / "staging" / "lenerp_core-44376c8214ad4c0974801d39cc1081a563233fd3.tar"
