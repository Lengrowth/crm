...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "94ec644a034d2abb5e0c025e37e3844107eb6df1"' in workflow
    assert bundle_commit == "94ec644a034d2abb5e0c025e37e3844107eb6df1"
    ...
    assert '"commit": "94ec644a034d2abb5e0c025e37e3844107eb6df1"' in baseline
