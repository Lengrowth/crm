...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "072f99d9c34441dd8b80729c56c7897bdb515591"' in workflow
    assert bundle_commit == "072f99d9c34441dd8b80729c56c7897bdb515591"
    ...
    assert '"commit": "072f99d9c34441dd8b80729c56c7897bdb515591"' in baseline
