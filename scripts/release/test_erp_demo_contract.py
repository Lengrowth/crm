...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert bundle_commit == "2eb71db1c633e0d97382ef8e8b92002909d6cbb0"
    ...
    assert '"commit": "2eb71db1c633e0d97382ef8e8b92002909d6cbb0"' in baseline
    ...
    archive = ROOT / "ops" / "staging" / "lenerp_core-2eb71db1c633e0d97382ef8e8b92002909d6cbb0.tar"
