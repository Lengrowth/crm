...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "c22163718f132af340685de3898719434265eec9"' in workflow
    assert bundle_commit == "c22163718f132af340685de3898719434265eec9"
    ...
    assert '"commit": "c22163718f132af340685de3898719434265eec9"' in baseline
