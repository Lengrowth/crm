...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "02e21b61d6b722f9032fd012c454c0ffd378c3bc"' in workflow
    assert bundle_commit == "02e21b61d6b722f9032fd012c454c0ffd378c3bc"
    ...
    assert '"commit": "02e21b61d6b722f9032fd012c454c0ffd378c3bc"' in baseline
