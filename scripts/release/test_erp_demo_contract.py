...
def test_staging_workflow_verifies_the_installed_custom_app_candidate():
    ...
    assert 'CUSTOM_APP_COMMIT: "cfb31ed81a04918880fc483bec238c5c24a3dd2e"' in workflow
    assert bundle_commit == "cfb31ed81a04918880fc483bec238c5c24a3dd2e"
    ...
    assert '"commit": "cfb31ed81a04918880fc483bec238c5c24a3dd2e"' in baseline
