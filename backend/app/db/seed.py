...
DEFAULT_MODULES = [
    ...
    {"code": "hr", "name": "HR", "category": "people", "description": "People records, attendance, and human resources operations.", "display_order": 60, "dependency_codes_json": [], "default_roles_json": ["hr_user", "admin"], "default_workspaces_json": ["Human Resources"], "required_app": "hrms", "minimum_app_version": "15.64.1", "compatible_app_version": "15.64.1", "is_marketed": True},
    {"code": "payroll", "name": "Payroll", "category": "people", "description": "Payroll processing and employee compensation workflows.", "display_order": 70, "dependency_codes_json": ["hr", "accounting"], "default_roles_json": ["payroll_user", "admin"], "default_workspaces_json": ["Payroll"], "required_app": "hrms", "minimum_app_version": "15.64.1", "compatible_app_version": "15.64.1", "is_marketed": True},
...
DEFAULT_BUNDLES = [
    ...
    {"bundle_key": "champion-drilling", "version": 2, "name": "Champion Drilling", "description": "Version 2 of the synthetic Champion drilling profile with HR, Payroll, Quality, and Support; HRMS-backed capabilities remain hidden until staging verification.", "modules": ["accounting", "buying", "selling", "stock", "assets", "crm", "projects", "field_ops", "well_mapping", "drilling", "fleet", "reporting", "hr", "payroll", "quality", "support"]},
