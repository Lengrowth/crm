...
| `lenerp_core` | Private `https://github.com/Len-OS/lenerp_core.git`; synthetic demo branch `codex/champ-c01-r1` at `f8427b1` (`0.2.0`) | C01–C08 synthetic DocTypes, roles, workflow, reports, print path, seed/status/reset; isolated ERP staging installation remains candidate-bound |
