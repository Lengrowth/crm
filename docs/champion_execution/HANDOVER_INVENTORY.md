...
| `lenerp_core` | Private `https://github.com/Len-OS/lenerp_core.git`; synthetic demo branch `codex/champ-c01-r1` at `7995bed` (`0.2.0`) | C01–C08 synthetic DocTypes, complete commercial/inventory/asset-maintenance seed, real role principals, workflow, reports, print path, read-only status/reset; isolated ERP staging installation remains candidate-bound |
...
- The next protected C01–C08 staging run is candidate-bound to the exact CRM
  ...
  `lenerp_core` archive pinned at `7995bed04a7079953e447e6bf430e90bf0558f80`.
