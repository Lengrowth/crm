...
| `lenerp_core` | Private `https://github.com/Len-OS/lenerp_core.git`; protected `main` candidate `6263833ef9c6f804f2f9d917667c91697ac0fd9b` (`0.2.0`) | C01–C08 synthetic DocTypes, complete commercial/inventory/asset-maintenance seed, real role principals, workflow, reports, print path, read-only status/reset, and app-owned ERP accessibility remediation; isolated ERP staging installation remains candidate-bound |
...
- The next protected C01–C08 staging run is candidate-bound to the exact CRM
  ...
  `lenerp_core` archive pinned at `6263833ef9c6f804f2f9d917667c91697ac0fd9b`.
