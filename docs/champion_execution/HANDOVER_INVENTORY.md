...
| `lenerp_core` | Private `https://github.com/Len-OS/lenerp_core.git`; protected `main` candidate `8fbdcb455bda1f250746be767f011c315d02a672` (`0.2.0`) | C01–C08 synthetic DocTypes, complete commercial/inventory/asset-maintenance seed, real role principals, workflow, reports, print path, read-only status/reset, and app-owned ERP accessibility remediation; isolated ERP staging installation remains candidate-bound |
...
- The next protected C01–C08 staging run is candidate-bound to the exact CRM
  ...
  `lenerp_core` archive pinned at `8fbdcb455bda1f250746be767f011c315d02a672`.
