...
| `lenerp_core` | Local private repository at `C:\Users\smikl\Desktop\Work\lenerp_core`; scaffold commit `d8cb884` | Remote ownership and disposable bench verification open |
...
- Reproducible staging-lane contract: `ops/staging/`; host/service/database/file evidence on the target host remains open.
