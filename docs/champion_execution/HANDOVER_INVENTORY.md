...
| `lenerp_core` | Private `https://github.com/Len-OS/lenerp_core.git`; synthetic demo branch `codex/champ-c01-r1` at `617ea2d` (`0.2.0`) | C01–C08 synthetic DocTypes, roles, workflow, reports, print path, seed/status/reset; isolated ERP staging installation remains candidate-bound |
...
- C01–C08 synthetic staging evidence is captured for candidate [14de22b](https://github.com/Lengrowth/crm/commit/14de22b278cf44386e4446aecce30d4d105a7575) in protected run [35405329393](https://github.com/Lengrowth/crm/actions/runs/35405329393). The exact `lenerp_core` pin is `617ea2d67be070b9fe1e389635d3e191edb66d3f`; the browser/accessibility artifact is [10572755648](https://github.com/Lengrowth/crm/actions/runs/35405329393/artifacts/10572755648) (23 files; SHA256 `c1346746bf27ffc033ff1656118832e843439ee561c5b717e6f1ee2242f791cb`). Persisted synthetic core counts are Company 1, Customer 3, Contact 3, Well Site 3, and Drilling Job 4. Optional ERPNext commercial/inventory counts are zero pending standard prerequisites. This is operator-validation staging evidence only: no Champion acceptance, real-data migration, Project Start approval, production activation, or final-domain cutover is claimed.
