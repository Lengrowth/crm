...
- Phase 3 remediation final-main staging run [35278665942](https://github.com/Lengrowth/crm/actions/runs/35278665942) produced browser artifact [10521149490](https://github.com/Lengrowth/crm/actions/runs/35278665942/artifacts/10521149490) for exact candidate `86fcde5b…`; the protected production promotion/readback is run [35279102175](https://github.com/Lengrowth/crm/actions/runs/35279102175) with artifact [10522240159](https://github.com/Lengrowth/crm/actions/runs/35279102175/artifacts/10522240159). It reports current `86fcde5b…`, previous `68926c22…`, active services, local health `200`, `platform_phase1_shell=true`, and clean upstream trees.
