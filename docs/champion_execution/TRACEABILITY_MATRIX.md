...
| Approved company settings, product identity and branding | `ORG-01`, `BRD-01`–`BRD-03` | `CHAMP-C01-R1` | `lenerp_core` value-free settings boundary; standard ERPNext settings applied only after approval | Clean install/migrate, light/dark/responsive, links, print/PDF and fallback assets | Acceptance authority (`AGR-02`) | Foundation in development; values pending |
