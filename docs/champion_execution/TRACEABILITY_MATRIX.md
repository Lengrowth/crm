...
| Champion ERP configured for well drilling and field service | `JOB-01`–`JOB-12`, `CRM-02`–`CRM-04`, `ORG-03`–`ORG-05` | `CHAMP-C04-R1`–`CHAMP-C07-R1` | `lenerp_core` DocTypes, fixtures, roles, workflows, reports and standard ERPNext links | Representative journeys 1–8, clean install/migrate, responsive and permission evidence | Authorized Champion UAT actors (`GLV-04`, `GLV-05`) | Synthetic implementation and protected staging/browser evidence captured; Champion UAT pending |
...
The exact candidate under protected re-review is CRM `dccff421027527860075c0c2de4ce08deccf5423` plus LenERP Core `26f41e34deab5fc699224657d206bd6a9d7bf161`, tracked by main run [35457401709](https://github.com/Lengrowth/crm/actions/runs/35457401709). Browser evidence covers every listed customer-facing route, and the ERP login, desktop, mobile, and authenticated business routes report zero serious axe violations. This is readiness for independent review, not Champion acceptance.
