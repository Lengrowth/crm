...
- `lenerp_core` commit: `2454b0dd13dbd4f076edc958e4a65b5c599f97bd` on
  `codex/champ-c01-r1`
...
| Frappe install/migrate on isolated staging | PENDING FINAL PROTECTED RUN | The workflow now deploys only the checksum-verified archive for `lenerp_core` `2454b0d…` |
