...
import { fetchTenant, listProvisioningJobs, listTenantDomains, manualActivateDomain, reactivateTenant, suspendTenant, updateTenant } from "@/lib/api";
...
export default function TenantDetailPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [domainResult, jobsResult] = await Promise.allSettled([listTenantDomains(tenantId), listProvisioningJobs(tenantId)]);
