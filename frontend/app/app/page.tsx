...
export default function AppHomePage() {
  ...
  const load = useCallback(async () => {
    ...
    const [summaryResult, organizationsResult, tenantsResult] = await Promise.allSettled([fetchDashboardSummary(), fetchOrganizations(5), fetchTenants(5)]);
